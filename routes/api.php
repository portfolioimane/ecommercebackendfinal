...
Route::group(['prefix' => 'admin/settings'], function () {
    ...
    // New routes for General Settings
    ...
    // New routes for Contact Information settings
    Route::get('contact-info', [SettingsController::class, 'getContactInfoSettings']);
    Route::post('contact-info', [SettingsController::class, 'updateContactInfoSettings']);

    // New routes for Social Media settings (including TikTok)
    Route::get('social-media', [SettingsController::class, 'getSocialMediaSettings']);
    Route::post('social-media', [SettingsController::class, 'updateSocialMediaSettings']);
});
